            ...
            <div class="row">
                ...
                <div class=" col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="footer-widget">
                        ...
                        <h3 class="footer-title">Addres</h3>
                        <ul><i class="fas fa-address-card fa-lg"></i>
                            <li><a href="#">{{$setting->address}}</a></li>
                            <li><a href="#">17th street</a></li>
                        </ul>
                    </div>
                </div>
                <!-- /.footer-services-links -->
                ...
                <div class=" col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="footer-widget">
                        ...
                        <div class="contact-info">
                            ...
                            <span class="contact-text">{{$setting->contact_email}}</span>
                        </div>
                        <div class="contact-info">
                            <span class="contact-text">{{$setting->contact_number}}</span>
                        </div>
                    </div>
                </div>
                <!-- /.footer-useful links -->
